...
// ============================================
// LOAN AUTOMATION ENGINE
// ============================================

router.post("/process-loans", async (req, res) => {
...
`, [
        ...
        res.json({
            ...
            message: "Loan processing completed",
            overdue_checked: true,
            penalties_applied: overdueLoans.rowCount,
            defaults_marked: defaultLoans.rowCount
